# Fiji v3.0.0 CLEWs model

This is the complete source, provenance and validation package for the MUIO
case `Fiji_v3`. Fiji v3.0.0 is an identity-only canonical successor of Fiji
v2.9.0: the editable model parameters are unchanged, while the case identity
and laptop-transfer workflow move to a simple result-free ZIP/push and
pull/unzip process.

- Current portable case: `muio/Fiji_v3_v3.0.0_MUIO.zip`
- Case identity: `Fiji_v3`
- Solver results: excluded
- Numerical predecessor: Fiji v2.9.0 at tag `v2.9.0`
...
The inherited v2.9 live run `Fisheries_Bounds_Table18_v2.9` solved optimally at CBC
...
The unchanged model formulation is suitable for national screening of a plausible aggregate
