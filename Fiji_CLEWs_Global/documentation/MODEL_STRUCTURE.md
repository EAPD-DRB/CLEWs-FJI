# Fiji CLEWs Global model structure

The raw Fiji case is one integrated model built from an energy lineage and a
spatial land–agriculture–water lineage.
...
The current structure therefore pools Viti Levu, Vanua Levu, Taveuni, Ovalau,
...
changes for the planned historical calibration.
...
- Final electricity demand and reported generation may have different
  boundaries because of station use and network losses.
