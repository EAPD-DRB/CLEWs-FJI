...
| `DS-RAW-SOLUTION` | Generated raw CBC and MUIO solutions | Baseline behavior, technical validation, and raw-versus-v2 comparison | Historical reference evidence | `diagnostics/raw_reference/`; immutable `Fiji_CLEWs_Global`; raw MUIO case |
...
|---|---|---|---|---|
| `DS-FJI-REI-IP` | Government of Fiji, *Renewable Energy Integration Investment Plan* | 2021 hydro, thermal, wind, and biomass/IPP fleet; generation cross-check | Active Fiji v2 historical input and evidence | Citation, local-file checksum, and extraction record: `evidence/calibration/SOURCE_EXTRACTS.md`; https://fijiclimatechangeportal.gov.fj/wp-content/uploads/2023/09/Fiji_CIF_REI_IP.pdf |
...
| `DS-EFL-AR-2024` | Energy Fiji Limited, *2024 Annual Report* | 2020–2024 generation by category, total grid supply, station use, and operating context | Active Fiji v2 calibration and held-out validation evidence | Citation, local-file checksum, and extraction record: `evidence/calibration/SOURCE_EXTRACTS.md`; https://efl.com.fj/wp-content/uploads/2025/05/EFL-2024-Annual-Report.pdf |
| `DS-FBS-ENERGY-ACCOUNT-2024` | Fiji Bureau of Statistics, *Experimental Environmental Account for Energy 2024* and physical supply-and-use workbook | Reconcile EFL gross supply with commercial, industrial, grid-served domestic, household own-generation, distribution-loss, and residual boundaries | Active Phase 1C historical model input | `evidence/energy/PHASE_1C_PROJECTION_SOURCE_EXTRACTS_2026-07-27.md`; `evidence/energy/fiji_energy_account_2024_electricity_boundary_2020_2024.csv`; https://www.statsfiji.gov.fj/fijis-experimental-environmental-account-for-energy-2024/ |
| `DS-FJI-MICS-2021` | Fiji Bureau of Statistics, Ministry of Health and Medical Services, and UNICEF, *Fiji Multiple Indicator Cluster Survey 2021 - Survey Finding Report* | Urban/rural central-grid access rates for the residential projection; weighted cooking technology/fuel shares for later service validation | Active Phase 1C residential projection input for grid access; cooking shares remain evidence only | `evidence/energy/PHASE_1C_PROJECTION_SOURCE_EXTRACTS_2026-07-27.md`; `evidence/energy/fiji_mics_2021_cooking_mix.csv`; https://www.statsfiji.gov.fj/mics-2021/ |
| `DS-FIJI-LEDS-2018` | Government of Fiji, *Fiji Low Emission Development Strategy 2018–2050* | BAU-unconditional commercial and industrial growth; household growth, urbanization, appliance adoption, energy intensity, and MEPS turnover | Active Phase 1C projection input | `evidence/energy/PHASE_1C_PROJECTION_SOURCE_EXTRACTS_2026-07-27.md`; `calculation_notes/PHASE_1C_BOTTOM_UP_ELECTRICITY.md`; PDF SHA-256 `eb424c7f05c4e038dcf12cf28814f80c300b7127dfc4850f088bc1c25db191eb`; https://fijiclimatechangeportal.gov.fj/wp-content/uploads/2022/01/Fiji_Low-Emission-Development-Strategy-2018-2050.pdf |
...
cross-vintage checks. Fiji v2 uses the internally consistent ten-year table on
printed page 88 of the 2024 report and retains the reported total rather than
averaging it with conflicting narrative figures. Boundary, rounding, and
conflict notes are in `evidence/calibration/SOURCE_EXTRACTS.md`.
...
| `DS-FBS-WATER-2024` | Fiji Bureau of Statistics, *Fiji's Experimental Environmental Account for Water 2024* | Annual 2020–2024 Water Authority surface abstraction, purification/distribution losses, and billed/carted public delivery | Active Phase 1B public-water input and evidence | `evidence/water/fiji_water_account_2024_public_supply_2020_2024.csv`; `../documentation/history/structural/PHASE_1B_PUBLIC_WATER_2026-07-27.md`; https://www.statsfiji.gov.fj/download/240/releases/4667/2024-fijis-experimental-environmental-account-for-water.pdf |
| `DS-FSC-ANNUAL-REPORTS` | Fiji Sugar Corporation annual reports, 2021–2025 | Annual cane crushed, sugar and molasses output for the 2020–2024 crushing seasons | Active Phase 1D input and held-out evidence | `evidence/energy/PHASE_1D_SOURCE_EXTRACTS_2026-07-28.md`; `evidence/energy/fiji_phase1d_cane_bagasse_power_balance_2020_2024.csv`; https://fsc.com.fj/annualreports/ |
| `DS-IRENA-SUGARCANE-2019` | International Renewable Energy Agency, *Sugarcane bioenergy in Southern Africa: Economic potential for sustainable scale-up* | Engineering proxy for exportable bagasse electricity after mill process-steam requirements | Active Phase 1D engineering input | `evidence/energy/PHASE_1D_SOURCE_EXTRACTS_2026-07-28.md`; PDF p. 37, Table 3.1; https://www.irena.org/-/media/Files/IRENA/Agency/Publication/2019/Apr/IRENA_Sugarcane_bioenergy_2019.pdf |
...
| `DS-UNSD-ENERGY-FJI` | United Nations Statistics Division, UNdata Energy Statistics, Fiji annual observations for 2020–2024 | Check whether the generic `Other hydrocarbons` carrier has a reported Fiji energy balance | Active structural applicability evidence | `evidence/energy/OHC_BRANCH_REVIEW_2026-07-26.md`; https://data.un.org/WS/rest/data/UNSD,DF_UNDATA_ENERGY,/.242../?startPeriod=2020&endPeriod=2024&format=csv |
| `DS-FJI-NIR-2023` | Government of Fiji, *National Inventory Report 2023* | Cross-check industrial combustion fuels and the accounting treatment of lubricants | Active structural applicability evidence | `evidence/energy/OHC_BRANCH_REVIEW_2026-07-26.md`; https://unfccc.int/sites/default/files/resource/Fiji_GHG%20NIR%202023_Final.pdf |
