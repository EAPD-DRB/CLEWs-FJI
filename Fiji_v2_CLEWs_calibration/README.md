...
- Most recent solved run: `Phase1B_Public_Water`
- Current result-free MUIO archive: `muio/Fiji_v2_v2.0.2_MUIO.zip`
...
The v2.0.2 source/input patch retains the v2.0.1 OHC correction and adds the
Phase 1B public-water closure. Its portable archive contains editable inputs
and excludes saved solver results. The 27 July live solve preserves the
energy fit metrics and calibration grade.
...
/opt/anaconda3/bin/python \
  ...
  --case-folder /path/to/MUIOGO/WebAPP/DataStorage/Fiji_v2 \
  --run Phase1B_Public_Water --phase 1B \
  --output-dir \
  Fiji_v2_CLEWs_calibration/diagnostics/topology/2026-07-27_phase1b_live
```
