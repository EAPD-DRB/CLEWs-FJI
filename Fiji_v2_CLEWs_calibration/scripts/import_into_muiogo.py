#!/usr/bin/env python3
"""Run MUIO's existing ImportTemplate against the prepared Fiji workbook."""
...
def main() -> None:
    ...
    parser.add_argument("--case", default="Fiji_CLEWs_Global")
    ...
    request = {
        ...
        "osy-desc": "Raw, uncalibrated Fiji CLEWs Global full-nexus model.",
        "osy-date": "2026-07-25",
        "osy-currency": "USD",
